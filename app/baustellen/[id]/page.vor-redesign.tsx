...
export default function BaustellenDetail() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f7f8] text-[#16181c]">
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-[1500px] px-6 py-5">
          ...
          <div className="mt-5 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            ...
            <div>
              <div className="text-xs font-black uppercase tracking-[0.18em] text-[#e5a72a]">
                {baustelle.nummer}
              </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span
                className={`flex items-center rounded-full px-4 py-2 text-sm font-bold ${
                  gesamtKritisch
                    ? "bg-red-100 text-red-700"
                    : gesamtOffen
                    ? "bg-[#fff2cc] text-[#8f6100]"
              ...
              <a
                ...
                className="rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold hover:bg-slate-50"
              >
                Sanierungsplan
              </a>
              ...
              <a
                ...
                className="rounded-xl bg-[#F2B632] px-5 py-3 text-sm font-black text-black hover:bg-[#e8aa2e]"
              >
                Zonenplan
              </a>
      ...
      <div className="mx-auto max-w-[1500px] space-y-5 p-6">
        ...
        {/* STATUSLEISTE */}
        <section className="overflow-hidden rounded-[24px] bg-[#18191c] text-white shadow-sm">

          <div className="grid gap-6 p-6 lg:grid-cols-[1.4fr_2fr]">

            <div className="flex items-center gap-5">

              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-[#F2B632] text-3xl font-black text-black">
                ✓
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              ...
              <div className="rounded-2xl bg-white/5 p-4">
                <strong className="block text-2xl text-[#F2B632]">
                  53
                </strong>
                <span className="text-xs text-slate-400">
                  SUVA Punkte
        ...
        <section className="grid grid-cols-2 gap-3 md:grid-cols-4 xl:grid-cols-8">
          ...
          <a
            ...
            className={`rounded-2xl border p-4 text-center shadow-sm transition ${
              personenInZone > 0
                ? "border-green-200 bg-green-50"
                : "border-slate-200 bg-white hover:border-[#F2B632]"
            }`}
          >
        ...
        <div className="grid gap-5 xl:grid-cols-[1.65fr_0.75fr]">
            ...
            <div className="mt-7 space-y-3">
              ...
              {checklisten.map((checkliste, index) => {
                ...
                return (
                  <div
                    key={checkliste.code}
                    className="group flex flex-col justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-4 transition hover:border-[#F2B632] md:flex-row md:items-center"
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <a
                        ...
                        className="rounded-xl bg-[#18191c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#F2B632] hover:text-black"
                      >
                        Öffnen →
                      </a>
          ...
          <div className="space-y-5">
            ...
            <section className="rounded-[22px] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <a
                href={`/baustellen/${id}/suva-audit`}
                className="mt-6 block w-full rounded-xl bg-[#F2B632] px-4 py-3 text-center text-sm font-black text-black hover:bg-[#e5a72a]"
              >
                SUVA Audit öffnen
              </a>
